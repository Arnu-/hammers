 ...
 * 导出按钮
 */
public class ButtonImportElementProcessor extends AbstractElementTagProcessor {
    ...
    public ButtonImportElementProcessor(String dialectPrefix) {
        super(
                // 模板类型为HTML
                TemplateMode.HTML,
                // 标签方言前缀
...
//        String tableName = iProcessableElementTag.getAttributeValue("tableName");
        StringBuffer result = new StringBuffer("<a href=\"javascript:\" " +
                "class=\"layui-btn btnOption layui-btn-normal layui-btn-small btnImport\" " +
                "id=\"import\" data-param=\"[]\" lay-event=\"import\">" +
                "<i class=\"layui-icon\">&#xe67c;</i>" + name + "</a>");
