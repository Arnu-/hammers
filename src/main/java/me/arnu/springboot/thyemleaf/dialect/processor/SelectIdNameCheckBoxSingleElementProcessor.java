...
// @Component
public class SelectIdNameCheckBoxSingleElementProcessor extends SelectIdNameElementProcessorBase {
    // 标签名
    ...
    protected String OPTION() {
        return "<input name=\"" + ELE_NAME + "[" + OPT_ID + "]\" lay-skin=\"primary\" " +
                "title=\"" + OPT_NAME + "\" " + SELECTED + " type=\"checkbox\">";
    }
    ...
    public SelectIdNameCheckBoxSingleElementProcessor(String dialectPrefix) {
