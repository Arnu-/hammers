 ...
 * 批量启用
 */
public class ButtonEAllElementProcessor extends AbstractElementTagProcessor {
    ...
    public ButtonEAllElementProcessor(String dialectPrefix) {
        super(
                // 模板类型为HTML
                TemplateMode.HTML,
                // 标签方言前缀
...
//        String tableName = iProcessableElementTag.getAttributeValue("tableName");
        StringBuffer result = new StringBuffer("<a href=\"javascript:\" " +
                "class=\"layui-btn btnOption layui-btn-warm layui-btn-small btnBatchEnable\" " +
                "id=\"batchEnable\" data-param=\"[&quot;" + param + "&quot;]\" " +
                "lay-event=\"batchEnable\"><i class=\"layui-icon layui-icon-play\">" +
                "</i>" + name + "</a>");
