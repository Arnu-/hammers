...
public class ButtonDAllElementProcessor extends AbstractElementTagProcessor {
    ...
    public ButtonDAllElementProcessor(String dialectPrefix) {
        super(
                // 模板类型为HTML
                TemplateMode.HTML,
                // 标签方言前缀
...
//        String tableName = iProcessableElementTag.getAttributeValue("tableName");
        StringBuffer result = new StringBuffer("<a href=\"javascript:\" class=\"layui-btn btnOption layui-btn-danger layui-btn-small btnBatchDrop\" id=\"batchDrop\" data-param=\"[]\" lay-event=\"batchDrop\"><i class=\"layui-icon layui-icon-delete\"></i>" + name + "</a>");
