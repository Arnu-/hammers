 ...
 * 批量禁用功能
 */
public class ButtonSAllElementProcessor extends AbstractElementTagProcessor {
    ...
    public ButtonSAllElementProcessor(String dialectPrefix) {
        super(
                // 模板类型为HTML
                TemplateMode.HTML,
                // 标签方言前缀
...
//        String tableName = iProcessableElementTag.getAttributeValue("tableName");
        StringBuffer result = new StringBuffer("<a href=\"javascript:\"" +
                " class=\"layui-btn btnOption layui-btn-danger layui-btn-small btnBatchDisable\"" +
                " id=\"batchDisable\" data-param=\"[&quot;" + param + "&quot;]\" lay-event=\"batchDisable\">" +
                "<i class=\"layui-icon layui-icon-pause\"></i>" + name + "</a>");
