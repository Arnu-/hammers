...
public class ButtonEditElementProcessor extends AbstractElementTagProcessor {
    ...
    public ButtonEditElementProcessor(String dialectPrefix) {
        super(
                // 模板类型为HTML
                TemplateMode.HTML,
                // 标签方言前缀
...
//        String tableName = iProcessableElementTag.getAttributeValue("tableName");
        StringBuffer result = new StringBuffer("<a class=\"layui-btn layui-btn-xs btnEdit\" " +
                "lay-event=\"edit\" title=\"" + name + "\">" +
