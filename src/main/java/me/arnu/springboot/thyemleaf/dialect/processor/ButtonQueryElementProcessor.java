...
public class ButtonQueryElementProcessor extends AbstractElementTagProcessor {
    ...
    public ButtonQueryElementProcessor(String dialectPrefix) {
        super(
                // 模板类型为HTML
                TemplateMode.HTML,
                // 标签方言前缀
...
//        String tableName = iProcessableElementTag.getAttributeValue("tableName");
        StringBuffer result = new StringBuffer("<button class=\"layui-btn\" lay-submit=\"\" lay-filter=\"searchForm\" id=\"search\"><i class=\"layui-icon\">&#xe615;</i>" + name + "</button>");
