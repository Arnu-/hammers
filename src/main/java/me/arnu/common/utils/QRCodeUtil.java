...
import me.arnu.common.config.QrImage;
...
public class QRCodeUtil {
    ...
    public static void main(String[] args) {
        // 演示案例一
        try {
            QRCodeUtil.encodeQrCode("taskwebui", 500, 500, "D:\\qrcode\\二维码(通过方式一生成).jpg");
            QRCodeUtil.encodeQrCodeAnotherWay("taskwebui", 500, 500, "D:\\qrcode\\二维码(通过方式二生成).jpg");
            // 生成带LOGO的二维码
            QRCodeUtil.encodeQrCodeWithEmbeddedImg("taskwebui", 500, 500, "D:\\qrcode\\logo.jpg",
            ...
            QrImage para = QrImage.builder().qrCodeFileOutputPath("D:\\qrcode\\带文字带图片的二维码.jpg")
                    ...
                    .embeddedImgFilePath("D:\\qrcode\\logo.png").wordContent("taskwebui").wordSize(20).build();
            ...
            QrImage para2 = QrImage.builder().qrCodeFileOutputPath("D:\\qrcode\\带文字不带图片的二维码.jpg")
                    .qrCodeContent("二维码").qrCodeWidth(500).qrCodeHeight(500).wordContent("taskwebui").wordSize(20).build();
