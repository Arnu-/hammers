...
CREATE TABLE if not exists `ums_employee_v2` (
...
insert into ums_employee_v2 (
        `id`,`employee_id`,`realname`,`nickname`,`gender`,`avatar`,
...
select `id`,`employee_id`,`realname`,`nickname`,`gender`,`avatar`,
       `mobile`,`email`,`birthday`,`dept_id`,`level_id`,`position_id`,
       `province_id`,`city_id`,`district_id`,`address`,`enrollment_date`,
       `formal_date`,`leave_date`,`work_year`,`status`,`note`,`create_user`,
       `create_time`,`update_user`,`update_time`,`mark`
...
DROP table if exists ums_employee_v1;

RENAME TABLE ums_employee TO ums_employee_v1;

RENAME TABLE ums_employee_v2 TO ums_employee;